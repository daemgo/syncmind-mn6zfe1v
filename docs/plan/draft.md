...
长机科技是专业的数控齿轮加工机床研发制造企业，总资产5亿余元，作为中型装备制造企业，其核心生产设备依赖高精度数控机床，以西门子数控系统为主控平台。企业已完成DCMM数据管理能力认证，具备中等数字化成熟度，对数据管理和智能制造有明确认知。

当前设备管理主要依赖人员经验，缺乏系统化的预防性维护机制，设备运行状态无法实现实时可视化监控，导致意外停机风险较高、维修响应效率受限。在数字化深化与智能制造升级战略下，客户希望建立EAM系统，实现设备全生命周期管理和运行状态可视化监控，降低设备故障对生产的影响。
...
以设备全生命周期管理为核心，以监控大屏为差异化亮点，构建"管理+监控"双轮驱动的EAM系统。通过设备台账建立数字化基础，通过预防性维护实现从被动维修向主动维护转变，通过监控大屏实现设备状态的实时可视化，通过西门子系统集成打通数据采集通道，最终实现设备管理的数据化、可视化、智能化。
...
### 基于客户信息的假设
1. 设备数量：假设为中型装备制造企业典型规模，约50-200台关键设备
2. 西门子系统：假设为主要采用西门子840D/828D等主流数控系统
3. 大屏部署：假设在车间现场和办公楼各部署1-2块
4. 用户规模：假设为30-50个并发用户
5. 网络环境：假设有完善的工业以太网，支持设备联网

### 待客户确认的关键信息
1. 项目决策人和关键干系人名单
2. 设备准确数量和类型分布
3. 西门子系统的具体型号和版本
4. 监控大屏的部署位置、尺寸、刷新频率要求
5. 客户正在评估的SaaS产品清单
6. 是否有历史维护记录电子化数据
